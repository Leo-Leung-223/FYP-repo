...
exports.handler = async (event) => {
  ...
  for (let j = 0; j < numberOfRecords; j++) {
    ...
    const externalImageIDIndex=decodeKey.lastIndexOf("/")
    const externalImageIdString = decodeKey.substring(externalImageIDIndex);
    const externalImageId=externalImageIdString.replace("/","")
